export default class Calculator {
  ...
  attack(jumpingAttack = 1) {
    ...
    return (
      Math.round(
        weaponAttack * this.d.heroics * this.d.fortify * jumpingAttack
      ) + this.d.attack
    );
  }
  ...
  _calculateAttack({ motion, affinity = null }) {
    const attack = this.attack(motion.jumpingAttack ? this.d.jumpingAttack : 1);
  ...
  _applySkill(skill) {
    switch (skill.typeId) {
      ...
      // 不屈
      case 21:
        this.d.fortify = skill.value1;
        break;
      // 飛燕
      case 22:
        this.d.jumpingAttack = skill.value1;
        break;
      // 超会心
      case 8:
