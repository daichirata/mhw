export default class Calculator {
  ...
  attack() {
    ...
    return (weaponAttack + this.d.attack) * this.d.heroics;
  }
  ...
  realDamage({ motion, affinity, hitData }) {
    const damage = Math.round(
      this._calculateAttack({ motion, affinity }) * hitData.slash * 0.01
    );
  ...
  _calculateAttack({ motion, affinity = null }) {
    ...
    return attack * motion.value * critical * sharpness * justHit * 0.01;
  }
